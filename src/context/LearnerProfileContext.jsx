...
export function LearnerProfileProvider({ children }) {
  ...
  }), [profile, effectiveLevel, experienceHighlightTick, dailyParisianPoints, setGender, completeOnboarding, setClaimedLevel, recordSample, mergeInterviewReport, gainExperience, spendExperience, markExerciseDone, incrementArticle, gainDailyParisianPoints, devCompleteLevel, refreshProfile, resetWelcomeOnboarding]);
