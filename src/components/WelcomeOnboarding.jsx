                          ...
                          >
                            {LEVEL_PICKER.filter(({ id }) => id !== 'C2').map(({ id, label, hint }) => (
                              <motion.button
                                ...
                                className={`group/badge relative flex items-center justify-center aspect-square w-full max-w-[210px] mx-auto hover:scale-[1.03] transition-transform ${id === 'C1' ? 'col-span-2 sm:col-span-1' : ''}`}
                              >
