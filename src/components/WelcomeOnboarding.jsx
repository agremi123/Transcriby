          ...
          <div className="px-6 sm:px-10 pt-6 pb-7">
            ...
            <div className="flex items-center justify-between mb-6">
              ...
              <a href="https://kruremi.com" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 group">
                <img src="/assets/remi-avatar.png" alt="Kru Rémi" className="w-14 h-14 rounded-full object-cover object-top ring-2 ring-wine/60 group-hover:ring-wine transition-all shrink-0" />
                <span className="font-display text-[16px] italic text-navy/60 leading-none whitespace-nowrap">
