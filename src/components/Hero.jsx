      ...
      <div className="px-7 pt-3 flex flex-col gap-2 flex-1 min-h-0">
        ...
        <div ref={writeBoxRef} className="relative bg-ivory/60 border border-line/70 overflow-hidden flex-1 flex flex-col min-h-0">
          ...
          {parisianWordChallenge && (
            <div className="shrink-0 mx-3.5 mt-2.5 mb-1 px-3 py-2 border-l-4 border-wine bg-wine/5" style={{ borderRadius: '0 4px 4px 0' }}>
              <div className="flex items-baseline gap-2 flex-wrap">
...
function ListeningPanel({ loading, title, audioUrl, transcript, wordTimings = null, source, date, vocab = [], questions = [], grammar = [], vocabTheme = '', contentLevel = '', parisianPercent = 0, dailyParisianPoints = 0, onSpendExperience }) {
  ...
  return (
    <div className="flex flex-col pr-4">
      {loading ? (
        <div className="flex flex-col gap-2.5 pt-2 w-[320px]">
          <div className="flex items-center gap-2 px-3 py-2 bg-navy/5 border border-navy/10 rounded-lg">
            <div className="w-6 h-6 rounded-full bg-wine/20 animate-pulse shrink-0" />
            ...
            />
              ...
              <div className="absolute -top-16 left-0 flex items-center gap-3 z-50">
                <a href="https://kruremi.com" target="_blank" rel="noopener noreferrer" className="shrink-0">
                  <img src="/assets/remi-avatar.png" alt="Kru Rémi" className="w-14 h-14 rounded-full object-cover object-top ring-2 ring-wine/60 transition-all hover:ring-wine" />
                </a>
